...
public class FileReceiveCommandHandler implements StreamObserver<ExecuteCommandPayload>
{
    private final StreamObserver<CommandResponse> responseObserver;  
    private FilePayloadReceiver filePayloadReceiver;
    
    public FileReceiveCommandHandler(File workingDirectory, StreamObserver<CommandResponse> responseObserver)
    {
