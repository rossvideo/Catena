...
public class DelegatingStreamObserver<C, D> implements StreamObserver<C>
{
    private StreamObserver<C> delegate;
    private StreamObserver<D> responseStream;
    private StreamObserverFactory<C, D> factory;
    
    public DelegatingStreamObserver(StreamObserverFactory<C, D> factory, StreamObserver<D> responseStream)
    {
