...
ParamDescriptor _helloDescriptor {catena::ParamType::STRING, {}, {{"en", "Text Box"},{"es", "Caja de texto"},{"fr", "Boîte de texte"}}, {}, "configure", false, "hello", nullptr, dm};
ParamWithValue<std::string> _helloParam {hello, _helloDescriptor, dm};
int32_t button {0};
ParamDescriptor _buttonDescriptor {catena::ParamType::INT32, {}, {{"en", "Button"},{"es", "Botón"},{"fr", "Bouton"}}, "button", "", false, "button", nullptr, dm};
catena::lite::ParamWithValue<int32_t> _buttonParam {button, _buttonDescriptor, dm};
catena::lite::NamedChoiceConstraint<int32_t> _buttonParamConstraint {{{0,{{"en","Off"},{"es","Apagado"},{"fr","Éteint"}}},{1,{{"en","On"},{"es","Encendido"},{"fr","Allumé"}}}}, false, "button", false, &_buttonParam};
int32_t offset {0};
