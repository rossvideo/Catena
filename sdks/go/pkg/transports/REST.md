...
- `GET /st2138-api/v1/{slot}/asset/{oid}` - ExternalObjectRequest equivalent (GetAsset)
- `POST /st2138-api/v1/{slot}/asset/{oid}` - LoadAsset (store a new asset, returns 204)
- `PUT /st2138-api/v1/{slot}/asset/{oid}` - OverwriteAsset (replace an asset, returns 204)
...
- Asset routes -> `RegisterGetAssetHandler` (GET), `RegisterLoadAssetHandler` (POST), `RegisterOverwriteAssetHandler` (PUT), `RegisterDeleteAssetHandler` (DELETE)
